...
bm25_folder = '/DATA/ezotova_data/ICD-10_CodiEsp/baseline_bm25' 
fasttext_folder = '/DATA/ezotova_data/ICD-10_CodiEsp/embeddings_fasstext'
sent_bert_folder = '/DATA/ezotova_data/ICD-10_CodiEsp/embeddings_sentbert'

# model_folder = "ICD-10-CodiEsp-BM25-icd_only-stop"

# 

# model_folder = "ICD-10-CodiEsp-SapBERT-UMLS-2020AB-all-lang-from-XLMR-large-icd_only"
model_folder = "ICD-10-CodiEsp-BioLORD-2023-M-icd_only"
# model_folder = "ICD-10-CodiEsp-BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext-icd_only"

# model_folder = "ICD-10-CodiEsp-biomed-icd_only-stop"
# model_folder = "ICD-10-CodiEsp-clinic-icd_only-stop"

# folder = "SNOMED-MedProcNER-SapBERT-UMLS-2020AB-all-lang-from-XLMR-large-snomed_only"
folder = os.path.join(sent_bert_folder, model_folder)
print(folder)

df_test = pd.read_csv(f'{folder}/sentbert_result.tsv', sep='\t', dtype=str).fillna('')
# df_test = df_test[:10]
...
# cross_encoder_name = "/DATA/ezotova_data/ICD-10_CodiEsp/cross-encoders/output/codiesp_cross_encoder-64-2024-07-12_19-41-25"
...
# cross_encoder_name = "/DATA/ezotova_data/ICD-10_CodiEsp/cross-encoders/output/codiesp_cross_encoder-codiesp-128-2024-07-15_09-57-13" 
cross_encoder_name = "/DATA/ezotova_data/ICD-10_CodiEsp/cross-encoders/output/codiesp_cross_encoder-codiesp-128-2024-07-17_14-58-35" # random
...
df_performance.to_csv(f'{folder}/{cross_encoder_name.split("/")[-1]}_scores.tsv', sep='\t', index=False)
